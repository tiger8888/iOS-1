...
// JCStockGraph
#define COCOAPODS_POD_AVAILABLE_JCStockGraph
#define COCOAPODS_VERSION_MAJOR_JCStockGraph 1
#define COCOAPODS_VERSION_MINOR_JCStockGraph 0
#define COCOAPODS_VERSION_PATCH_JCStockGraph 1
